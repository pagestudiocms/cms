...
class Flex_Menu 
{
	...
	*/
	...
	public function add($title, $options)
	{
		...
		// making an instance of Flex_Item class
		$item = new Flex_Item($this, $title, $url, $attr, $pid);
	...
	/**
	 * Return Flex_Items at root level
	 *
	 * @return array
	 */
	...
	/**
	 * Return Flex_Items at the given level
	 *
	 * @param  int  $parent
	 * @return array
	 */
