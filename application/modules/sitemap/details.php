...
class Details extends Module
{
    public static function info()
    {
        return [
            'name'          => 'Sitemap',
            'slug'          => 'sitemap',
            'description'   => 'The Sitemap add-on automatically generates a configurable sitemap of your website. It is meant as an SEO tool for site administrators that use PageStudioCMS.',
            'version'       => '0.1',
