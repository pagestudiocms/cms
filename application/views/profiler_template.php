...
<style type="text/css">
#codeigniter-profiler{clear:both;background:#222;padding:0 5px;font-family:Helvetica,sans-serif;font-size:10px!important;line-height:12px;text-align:left;position:absolute;width:100%;min-width:74em;max-width:100%;z-index:1000;display:none}#codeigniter-profiler.bottom-right{position:fixed;bottom:0;right:0;-webkit-box-shadow:-1px -1px 10px #999;-moz-box-shadow:-1px -1px 10px #999;box-shadow:-1px -1px 10px #999}#codeigniter-profiler.bottom-left{position:fixed;bottom:0;left:0;-webkit-border-top-right-radius:7px;-moz-border-radius-topright:7px;border-top-right-radius:7px;-webkit-box-shadow:1px -1px 10px #999;-moz-box-shadow:1px -1px 10px #999;box-shadow:1px -1px 10px #999}#codeigniter-profiler.top-left{position:fixed;top:0;left:0;-webkit-border-bottom-right-radius:7px;-moz-border-radius-bottomright:7px;border-bottom-right-radius:7px;-webkit-box-shadow:1px 1px 10px #999;-moz-box-shadow:1px 1px 10px #999;box-shadow:1px 1px 10px #999}#codeigniter-profiler.top-right{position:fixed;top:0;right:0;-webkit-border-bottom-left-radius:7px;-moz-border-radius-bottomleft:7px;border-bottom-left-radius:7px;-webkit-box-shadow:-1px 1px 10px #999;-moz-box-shadow:-1px 1px 10px #999;box-shadow:-1px 1px 10px #999}#codeigniter-profiler.bottom{position:fixed;bottom:0;left:0;right:0;width:100%;max-width:100%;-webkit-box-shadow:0 1px 10px #999;-moz-box-shadow:0 1px 10px #999;box-shadow:0 1px 10px #999}#codeigniter-profiler.top{position:fixed;top:0;left:0;right:0;width:100%;max-width:99.5%;-webkit-box-shadow:-1px 1px 10px #999;-moz-box-shadow:-1px 1px 10px #999;box-shadow:-1px 1px 10px #999}.ci-profiler-box{padding:10px;margin:0 0 10px;max-height:400px;overflow:auto;color:#fff;font-family:Monaco,'Lucida Console','Courier New',monospace;font-size:11px!important}.ci-profiler-box h2{font-family:Helvetica,sans-serif;font-weight:700;font-size:16px!important;padding:0;line-height:2}#ci-profiler-vars a{text-decoration:none}#ci-profiler-menu a:link,#ci-profiler-menu a:visited{display:inline-block;padding:7px 0;margin:0;color:#ccc;text-decoration:none;font-weight:lighter;cursor:pointer;text-align:center;width:13%;border-bottom:4px solid #444}#ci-profiler-menu a.current,#ci-profiler-menu a:hover{background-color:#222;border-color:#999}#ci-profiler-menu a span{display:inline-block;font-weight:700}#ci-profiler-menu a .ci-profiler-meta{background-color:#4F4F4F;color:#FFF!important;padding:2px 6px;font-size:11px;-webkit-border-radius:1px;-moz-border-radius:1px;border-radius:1px}#ci-profiler-menu a .ci-profiler-badge{text-transform:uppercase;font-size:11px;padding-right:6px}#ci-profiler-benchmarks h2,#ci-profiler-menu-time span{color:#B72F09}#ci-profiler-memory h2,#ci-profiler-menu-memory span{color:#953FA1}#ci-profiler-menu-queries span,#ci-profiler-queries h2{color:#3769A0}#ci-profiler-eloquent h2,#ci-profiler-menu-eloquent span{color:#f4726d}#ci-profiler-menu-vars span,#ci-profiler-vars h2{color:#D28C00}#ci-profiler-console h2,#ci-profiler-files h2,#ci-profiler-menu-console span,#ci-profiler-menu-files span{color:#5a8616}#codeigniter-profiler table{width:100%}#codeigniter-profiler table.main td{padding:7px 15px;text-align:left;vertical-align:top;color:#aaa;border-bottom:1px dotted #444;line-height:1.5;background:#101010!important;font-size:12px!important}#codeigniter-profiler table.main tr:hover td{background:#292929!important}#codeigniter-profiler table.main code{font-family:inherit;padding:0;background:0 0;border:0;color:#fff}#codeigniter-profiler table .hilight{color:#FFFD70!important}#codeigniter-profiler table .faded{color:#aaa!important}#codeigniter-profiler table .small{font-size:10px;letter-spacing:1px;font-weight:lighter}#ci-profiler-menu-exit{background:url(data:image/png;base64,) no-repeat;padding-left:20px;position:absolute;right:5px;top:10px;display:none}#ci-profiler-menu-open{background:url(data:image/png;base64,%3D) 50% 50% no-repeat #222;z-index:10000}#ci-profiler-menu-open.bottom-right{position:fixed;right:-2px;bottom:0;width:40px;height:35px}#ci-profiler-menu-open.bottom-left{position:fixed;left:10px;bottom:22px}#ci-profiler-menu-open.top-left{position:fixed;left:10px;top:22px}#ci-profiler-menu-open.top-right{position:fixed;right:-2px;top:22px}
</style>
...
<a href="#" id="ci-profiler-menu-open" class="<?php echo $bar_location ?>" onclick="ci_profiler_bar.open(); return false;">&nbsp;</a>
	...
	<div id="ci-profiler-menu">
		...
		<?php if (isset($sections['console'])) : ?>
			<a href="#" id="ci-profiler-menu-console" onclick="ci_profiler_bar.show('ci-profiler-console', 'ci-profiler-menu-console'); return false;">
				<span class="ci-profiler-badge">Console</span>
				<span class="ci-profiler-meta"><?php echo is_array($sections['console']) ? $sections['console']['log_count'] + $sections['console']['memory_count'] : 0 ?></span>
			</a>
		<?php endif; ?>
		...
		<?php if (isset($sections['benchmarks'])) :?>
			<a href="#" id="ci-profiler-menu-time" onclick="ci_profiler_bar.show('ci-profiler-benchmarks', 'ci-profiler-menu-time'); return false;">
				<span class="ci-profiler-badge">Load Time</span>
				<span class="ci-profiler-meta"><?php echo $this->benchmark->elapsed_time('total_execution_time_start', 'total_execution_time_end') ?> s</span>
			</a>
			<a href="#" id="ci-profiler-menu-memory" onclick="ci_profiler_bar.show('ci-profiler-memory', 'ci-profiler-menu-memory'); return false;">
				<span class="ci-profiler-badge">Memory Used</span>
				<span class="ci-profiler-meta"><?php echo (! function_exists('memory_get_usage')) ? '0' : round(memory_get_usage()/1024/1024, 2).' MB' ?></span>
			</a>
		<?php endif; ?>
		...
		<?php if (isset($sections['queries'])) : ?>
			<a href="#" id="ci-profiler-menu-queries" onclick="ci_profiler_bar.show('ci-profiler-queries', 'ci-profiler-menu-queries'); return false;">
				<span class="ci-profiler-badge">Database Queries</span>
				<span class="ci-profiler-meta"><?php echo is_array($sections['queries']) ? (count($sections['queries']) - 1) : 0 ?></span>
			</a>
		<?php endif; ?>
		...
		<?php if (isset($sections['eloquent'])) : ?>
			<a href="#" id="ci-profiler-menu-eloquent" onclick="ci_profiler_bar.show('ci-profiler-eloquent', 'ci-profiler-menu-eloquent'); return false;">
				<span class="ci-profiler-badge">Illuminate\Database</span>
				<span class="ci-profiler-meta"><?php echo is_array($sections['eloquent']) ? (count($sections['eloquent']) - 1) : 0 ?> Eloquent</span>
			</a>
		<?php endif; ?>
		...
		<?php if (isset($sections['http_headers']) || isset($sections['get']) || isset($sections['config']) || isset($sections['post']) || isset($sections['uri_string']) || isset($sections['controller_info'])) : ?>
			<a href="#" id="ci-profiler-menu-vars" onclick="ci_profiler_bar.show('ci-profiler-vars', 'ci-profiler-menu-vars'); return false;">
				<span class="ci-profiler-meta" style="background: none;padding-left:0;padding-right:0;">&nbsp;</span> 
                <span class="ci-profiler-badge">vars &amp; Config</span>
			</a>
		<?php endif; ?>
		...
		<?php if (isset($sections['files'])) : ?>
			<a href="#" id="ci-profiler-menu-files" onclick="ci_profiler_bar.show('ci-profiler-files', 'ci-profiler-menu-files'); return false;">
                <span class="ci-profiler-badge">Files</span>
				<span class="ci-profiler-meta"><?php echo is_array($sections['files']) ? count($sections['files']) : 0 ?></span> 
			</a>
		<?php endif; ?>
