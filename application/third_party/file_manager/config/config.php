<?php
/**
 * The adaptation of Responsive Filemanager for use in CodeIgniter 
 * and PageStudioCMS as a module and CKEditor plugin.
 *
 * PHP version 5.4 >
 * 
 * LICENSE: Creative Commons
 * 
 * @author     Alberto <trippo@hotmail.it>
 * @author     Cosmo Mathieu <cosmo@cosmointeractive.co>
 * @copyright  Tec Rails (c) 2011 http://www.tecrail.com
 * @copyright  Cosmo Interactive (c) 2011 http://www.cosmointeractive.co
 * @license    https://github.com/trippo/ResponsiveFilemanager/blob/master/LICENSE.TXT
 * @link       https://github.com/trippo/ResponsiveFilemanager 
 * @see        
 * @version    0.2.9
 * @modified   06/07/2016 by Cosmo 
 */
...
/*
|--------------------------------------------------------------------------
| Website base path/url configuration
|--------------------------------------------------------------------------
|
| Setting the website base path and base url
|
*/
...
$config = array(
	...
	*/
	// 'upload_dir' => '/source/',
	'upload_dir' => 'assets/cms/uploads/images/',
	...
	*/
	// 'current_path' => '../source/',
	'current_path' => '../../../assets/cms/uploads/images/',
	...
	*/
	...
	'thumbs_base_path' => '../../../assets/cms/uploads/.thumbs/images/',
...
/*
|--------------------------------------------------------------------------
| Path configuration alterations
|--------------------------------------------------------------------------
| Modifying default file paths for adaptation to PageStudioCMS
|
| Default path description and explanation:
| $base_url          (only domain) of site (without final /). If you prefer relative urls leave empty
